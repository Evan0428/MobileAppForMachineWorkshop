...
class _JobDetailScreenState extends State<JobDetailScreen> {
  ...
  void initState() {
    ...
    // read id from arguments after the first frame
              ...
              Column(
                children: [
                  ...
                  ...job.notes.map((n) => Card(
                    child: ListTile(
                      leading: n.photoPath != null ? Image.file(File(n.photoPath!), width: 56, height: 56, fit: BoxFit.cover) : const Icon(Icons.note),
